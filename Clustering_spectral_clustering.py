...
def spectra(similarity):
    cl = SpectralClustering(n_clusters=3, affinity = 'precomputed', eigen_solver='arpack')
...
#            print master_data.shape, labels.shape
            ...
            np.savetxt(save_path + 'SC_clustering.csv', master_data, \
...
plotTernary.plt_ternary_save(ternary_data, tertitle='',  labelNames=('Co','Fe','Zr'), scale=100,
                       sv=True, svpth=save_path, svflnm='SC_clustering',
