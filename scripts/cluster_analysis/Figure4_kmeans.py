...
plotTernary.plt_ternary_save(ternary_data, tertitle='',  labelNames=('Co','Fe','Zr'), scale=100,
                       sv=True, svpth=save_path, svflnm='Kmeans',
                       cbl='labels', cmap='viridis', cb=True, style='h')


# ternary_data = np.concatenate(([centers_Co],[centers_Fe],[centers_Zr],[[0,1,2,3,4]]), axis = 0)
# ternary_data = np.transpose(ternary_data)
#
# plotTernary.plt_ternary_save(ternary_data, tertitle='',  labelNames=('Co','Fe','Zr'), scale=100,
#                        sv=True, svpth=save_path, svflnm='Kmeans',
